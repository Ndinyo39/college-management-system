...
export default function Attendance() {
    ...
    const fetchRegistry = async () => {
        try {
            ...
            const filtered = data.filter(s => s.course === selectedCourse);
    ...
    const fetchStudentHistory = async () => {
        try {
            // Simplified demo: Sarah Johnson's history
            const demoHistory = [
                { date: '2026-02-05', course: 'Cosmetology', status: 'Present' },
                { date: '2026-02-04', course: 'Cosmetology', status: 'Present' },
                { date: '2026-02-03', course: 'Cosmetology', status: 'Absent' },
                { date: '2026-02-02', course: 'Cosmetology', status: 'Present' },
            ];
            setStudents(demoHistory);
        } catch (error) {
