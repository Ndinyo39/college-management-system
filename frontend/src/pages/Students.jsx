                    ...
                    <div className="bg-white rounded-[2.5rem] p-12 max-w-2xl w-full shadow-3xl border border-maroon/10 scale-in-center overflow-hidden relative">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8 max-h-[70vh] overflow-y-auto pr-4 custom-scrollbar">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        <label className="text-[10px] font-black text-maroon/40 uppercase tracking-widest ml-1">DOB</label>
                                        <input
                                            type="date"
                                            value={formData.dob}
                                    ...
                                    <div className="space-y-1">
                                        <label className="text-[10px] font-black text-maroon/40 uppercase tracking-widest ml-1">Blood Group</label>
                                        <select
